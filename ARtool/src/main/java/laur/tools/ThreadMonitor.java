...
/**
   ...
   This interface is implemented by classes who are interested in
   monitoring a thread.
...
{
  /**
   * This method will be called upon the thread's termination. The
   * thread that terminated will pass itself as a parameter.
   */
  void threadTermination(Thread t); 
}

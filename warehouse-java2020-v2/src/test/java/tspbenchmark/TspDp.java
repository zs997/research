...
public class TspDp {
    ...
    public static void main(String[] args) {
        double[][] first = {	//各个节点之间路径长度的二维数组
                {0,   257, 187, 91,  150, 80},
                {257, 0,   196, 228, 112, 196},
                {187, 196, 0,   158, 96,  88},
                {91,  228, 158, 0,   120, 77},
                {150, 112, 96,  120, 0,   63},
                {80,  196, 88,  77,  63,   0}
                };
        DistanceInstance instance24 = DistanceInstance.getInstance24();
        first = instance24.getDistanceMatrix();
        long start = System.currentTimeMillis();
        TspDp ff = new TspDp(first);

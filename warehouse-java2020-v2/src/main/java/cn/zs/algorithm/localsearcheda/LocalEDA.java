...
public class LocalEDA<T extends Column>{
    ...
    private Class<T> t;
    //局部搜索次数
    private int localSearchTimes = 10;

    public LocalEDA(int populationSize, int superiorityCount, double alpha, int maxGenerations, int eliteCount, Class<T> t) {
...
//        }
    ...
    public Individual localSearchIndividualByReverse(Individual individual){
        Route route = new Route(individual,t);

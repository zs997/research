 ...
 */
package tspbenchmark.tspsabenchmark;
import tspbenchmark.DistanceInstance;
import tspbenchmark.tspedasabenchmark2.Individual;
...
public class Route{
    ...
    public Route(DistanceInstance distanceInstance){
        this.distanceInstance = distanceInstance;
        bestRoute = new int[distanceInstance.getCityNum()];
